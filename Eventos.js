...
// IMPORTA O SERVIÇO QUE PUXA EVENTOS DO SERVIDOR
...
export default function Eventos() {
  ...
  async function carregar() {
    try {
      const dados = await listarEventos(); // <- CHAMA O SERVIDOR
      setEventos(dados);                   // <- ATUALIZA A TELA
    } catch (e) {
      console.log("Erro ao carregar eventos:", e);
    }
  }

  // MARCAR / DESMARCAR FAVORITO (LOCAL)
