...
import { StyleSheet, Text, View, TouchableOpacity, TextInput, ScrollView, ActivityIndicator, Linking, Alert, SafeAreaView, Image } from 'react-native';
...
export default function Hospedagem() {
    ...
    useFocusEffect(
        useCallback(() => { carregarFavoritosLocais(); }, [])
    );
    ...
    async function carregarHospedagem() {
        let dados = null;
        if (apiServices?.listarHospedagem) {
            const res = await apiServices.listarHospedagem();
            dados = res?.data ?? res;
        } else if (apiServices?.getHospedagem) {
                    ...
                    return (
                        ...
                        >
                            ...
                            <View style={styles.imagemCiculo}>
                                {h.imagem ? (
                                    <Image source={{ uri: h.imagem }} style={styles.imagemCiculo} resizeMode="cover" />
                                ) : (
