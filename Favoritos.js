...
import { StyleSheet, Text, View, TouchableOpacity, ScrollView, TextInput, ActivityIndicator, Alert, Linking } from "react-native";
            ...
            <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 120 }}>
                {filtrados.length === 0 ? (
                    ...
                    filtrados.slice(0, quantidade).map((item, index) => {
                        ...
                        const podeAbrirMapa = item.tipo === 'restaurante' || item.tipo === 'ponto';
                        const isFav = true;
                        ...
                        return (
                            ...
                            >
                                ...
                                <View style={styles.info}>
                                    ...
                                    {podeAbrirMapa && item.latitude && item.longitude && (
...
const styles = StyleSheet.create({
    ...
    titulo: { fontSize: 25, fontWeight: "bold", color: "#000" },
    ...
    endereco: { fontSize: 12, color: '#0066cc', fontStyle: 'italic', textDecorationLine: 'underline' },
