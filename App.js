      ...
      <View style={styles.container}>
        ...
        <View style={styles.buttonsContainer}>
          ...
          <TouchableOpacity style={styles.avaliar} onPress={() => setTelaAtual('avaliar')}>
            <Text style={styles.avaliarTexto}>Deixe sua avaliação</Text>
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.conteudo}>
        ...
        {telaAtual === 'mapa' && (
          <View style={styles.telaPlaceholder}>
            <Text style={styles.textoConteudo}>Tela do Mapa</Text>
            <Text style={styles.textoConteudo}>Em desenvolvimento...</Text>
            <TouchableOpacity 
              style={styles.botaoVoltar} 
              onPress={() => setTelaAtual('home')}
            >
              <Text style={styles.botaoTextoPrincipal}>Voltar</Text>
            </TouchableOpacity>
          </View>
        )}
