...
export default function Restaurantes() {
  ...
  async function carregar() {
    try {
      ...
      console.log("Erro ao carregar restaurantes:", e.message);
    } finally {
      setLoading(false);
    }
  }
  ...
  // Lista completa dos favoritos
  const favoritosCompletos = restaurantes.filter(r => favoritos.includes(r.place_id));
          ...
          return (
            ...
            >
              ...
              <TouchableOpacity
                ...
                onPress={() => toggleFavorito(item.place_id)}
              >
                <Ionicons
                  name={favoritos.includes(item.place_id) ? "heart" : "heart-outline"}
                  size={24}
                  color="#FB8837"
                />
              </TouchableOpacity>
